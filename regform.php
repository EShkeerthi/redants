...
<div id="main-wrapper">
  ...
  <div class="container-fluid">
    <div class="row">
	  ...
	  <div> </div>
	  <form method="post" onsubmit="return false" name="register">
          ...
          <label class="input__label input__label--hoshi input__label--hoshi-color-3" for="name">
			...
			<span class="input input--hoshi">
          <input class="input__field input__field--hoshi" type="text" name="fname"  />
          <label class="input__label input__label--hoshi input__label--hoshi-color-3" for="name">
...
function reg(){
  ...
  return false
        ...
        <div class="cta">
          <button class="btn btn-primary pull-left" onclick="reg()" type="submit">
            Register Now
          </button>
